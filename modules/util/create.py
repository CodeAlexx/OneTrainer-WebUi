...
from modules.modelLoader.QwenImageEditLoRAModelLoader import QwenImageEditLoRAModelLoader
...
from modules.modelSampler.QwenImageEditSampler import QwenImageEditSampler
...
from modules.modelSaver.QwenImageEditLoRAModelSaver import QwenImageEditLoRAModelSaver
...
def create_model_loader(
    ...
    match training_method: #TODO simplify
        ...
        case TrainingMethod.LORA:
            ...
            if model_type.is_qwen_image_edit():
                return QwenImageEditLoRAModelLoader()
            if model_type.is_z_image():
...
def create_model_saver(
    ...
    match training_method:
        ...
        case TrainingMethod.LORA:
            ...
            if model_type.is_qwen_image_edit():
                return QwenImageEditLoRAModelSaver()
            if model_type.is_z_image():
...
def create_model_setup(
    ...
    match training_method:
        ...
        case TrainingMethod.LORA:
            ...
            if model_type.is_qwen_image_edit():
                return QwenImageEditLoRASetup(train_device, temp_device, debug_mode)
            if model_type.is_z_image():
...
def create_model_sampler(
    ...
    match training_method:
        case TrainingMethod.FINE_TUNE | TrainingMethod.LORA | TrainingMethod.EMBEDDING:
            ...
            if model_type.is_qwen_image_edit():
                return QwenImageEditSampler(train_device, temp_device, model, model_type)
            if model_type.is_z_image():
...
def create_data_loader(
    ...
    match training_method:
        case TrainingMethod.FINE_TUNE | TrainingMethod.LORA | TrainingMethod.EMBEDDING:
            ...
            if model_type.is_qwen_image_edit():
                return QwenImageEditDataLoader(train_device, temp_device, config, model, train_progress, is_validation)
            if model_type.is_z_image():
