...
def build_general_tab(ui_state: UIState) -> None:
    ...
    # -- Debug & Logging ----------------------------------------------------
    labeled_separator("Debug & Logging")
    ...
    # -- Device Settings ----------------------------------------------------
    labeled_separator("Device Settings")
