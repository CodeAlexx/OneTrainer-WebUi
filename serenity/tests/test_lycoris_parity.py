...
class TestLyCORISManagerParity:
    ...
    def test_adapter_types_enum(self):
        ...
        from serenity.training.lycoris_manager import AdapterType
...
class TestLyCORISConfigSupport:
    ...
    def test_locon_config(self):
        ...
        from serenity.training.lycoris_manager import LoConConfig
    ...
    def test_loha_config(self):
        ...
        from serenity.training.lycoris_manager import LoHaConfig
    ...
    def test_lokr_config(self):
        ...
        from serenity.training.lycoris_manager import LoKrConfig
    ...
    def test_ia3_config(self):
        ...
        from serenity.training.lycoris_manager import IA3Config
    ...
    def test_oft_config(self):
        ...
        from serenity.training.lycoris_manager import OFTConfig
    ...
    def test_glora_config(self):
        ...
        from serenity.training.lycoris_manager import GLoRAConfig
    ...
    def test_dylora_config(self):
        ...
        from serenity.training.lycoris_manager import DyLoRAConfig
...
class TestAdapterModuleSupport:
    ...
    def test_adapter_registry_complete(self):
        ...
        from serenity.adapters import ADAPTER_REGISTRY, AdapterType
    ...
    def test_adapter_detection(self):
        ...
        from serenity.adapters import AdapterType, detect_adapter_type
...
class TestEMASupport:
    ...
    def test_ema_module_exists(self):
        ...
        from serenity.training.ema import EMAMode, EMAModel, EMAModule
    ...
    def test_ema_modes(self):
        ...
        from serenity.training.ema import EMAMode
...
class TestLossSupport:
    ...
    def test_snr_weighted_loss(self):
        ...
        from serenity.training.losses import snr_weighted_loss

        assert callable(snr_weighted_loss)

    def test_velocity_loss(self):
        """Test velocity loss exists (SD3 feature)."""
        from serenity.training.losses import velocity_loss
...
class TestNoiseConfigSupport:
    ...
    def test_noise_config_has_offset_noise(self):
        ...
        from serenity.core.config import NoiseConfig
...
class TestFeatureParitySummary:
    ...
    def test_zimage_parity(self):
        ...
        from serenity.training.lycoris_manager import DEFAULT_TARGETS, AdapterType
    ...
    def test_sd3_exceeds_simpletuner(self):
        ...
        from serenity.training.lycoris_manager import DEFAULT_TARGETS, AdapterType, LyCORISManager
        ...
        from serenity.training.lycoris_manager import AdapterConfig
...
class TestLyCORISRuntime:
    ...
    def test_lokr_attach_optimizer_and_save(self, tmp_path):
        from serenity.training.lycoris_manager import AdapterConfig, AdapterType, LyCORISManager
    ...
    def test_target_modules_emit_custom_preset(self, monkeypatch):
        from serenity.training import lycoris_manager as lm
        from serenity.training.lycoris_manager import AdapterConfig, AdapterType, LyCORISManager
