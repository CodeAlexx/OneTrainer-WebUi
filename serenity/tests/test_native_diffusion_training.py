...
from serenity.cli.native_diffusion import (
    _DistributedContext,
    _compute_vae_loss,
...
def test_maybe_wrap_distributed_module_wraps_when_enabled(monkeypatch):
    ...
    monkeypatch.setattr("serenity.cli.native_diffusion.DistributedDataParallel", _DummyDDP)
...
def test_maybe_sample_expands_prompts_and_seeds(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "serenity.cli.native_diffusion.create_sampler",
