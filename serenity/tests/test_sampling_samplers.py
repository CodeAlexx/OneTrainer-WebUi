...
def test_sdxl_sampler_uses_local_files_only_and_quantizes_resolution(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("serenity.sampling.sampler._load_pipeline_class", _load_class)
...
def test_zimage_sampler_loads_assistant_lora(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("serenity.sampling.sampler._load_pipeline_class", lambda _name: _DummyZImagePipeline)
