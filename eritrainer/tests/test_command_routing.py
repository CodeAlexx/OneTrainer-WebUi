...
from eritrainer.cli import commands
from eritrainer.cli.commands import (
...
def test_train_command_defaults_to_native_without_opt_in(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("eritrainer.cli.native_diffusion.is_native_diffusion_model_type", lambda _model_type: True)
    ...
    monkeypatch.setattr("eritrainer.cli.native_diffusion.run_native_diffusion_training", _fake_run_native_diffusion)
...
def test_train_command_converts_onetrainer_config_to_native(monkeypatch, tmp_path):
