...
class TestLayerOffloadConductorBasic:
    ...
    def test_conductor_creation(self):
        ...
        from eritrainer.training.layer_offload import LayerOffloadConductor
...
class TestBlockSwapMemory:
    ...
    def test_weights_move_to_cpu(self):
        ...
        from eritrainer.training.block_swap import weights_to_device
...
class TestMemorySyncUtilities:
    ...
    def test_device_equals(self):
        ...
        from eritrainer.memory.sync import device_equals
    ...
    def test_tensors_match_device(self):
        ...
        from eritrainer.memory.sync import tensors_match_device
...
class TestStaticAllocators:
    ...
    def test_static_layer_allocator_creation(self):
        ...
        from eritrainer.memory.allocators import StaticLayerAllocator
    ...
    def test_static_activation_allocator_creation(self):
        ...
        from eritrainer.memory.allocators import StaticActivationAllocator
...
class TestGradientCheckpointing:
    ...
    def test_gradient_checkpointing_off(self):
        ...
        from eritrainer.training.gradient import setup_gradient_checkpointing
