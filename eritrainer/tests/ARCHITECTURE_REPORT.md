...
|------|-------------------|---------|
| `eritrainer/models/flux2_klein.py` | `Flux2KleinModel`, `Flux2KleinModelLoader` | FLUX.2 Klein model wrapper and loader |
| `eritrainer/models/base.py` | `BaseModel` (ABC) | Abstract base for all models |
| `eritrainer/components/model_setup.py` | `Flux2KleinModelSetup`, `create_model_setup()` | Model initialization for training |
| `eritrainer/training/predict.py` | `Flux2KleinPredictor`, `get_predictor()` | Forward pass implementations |
| `eritrainer/components/model_loader.py` | `create_model_loader()` | Model loader factory |
| `eritrainer/core/enums.py` | `ModelType.FLUX_2_KLEIN_*`, `is_flux_2_klein()` | Model type enums and helpers |

## MEMORY LAYER (discovered)

### Core Memory Management (`eritrainer/memory/`)
...
### Block Swapping (`eritrainer/training/block_swap.py`)
...
### Main Trainer (`eritrainer/core/trainer.py`)
...
### Data Pipeline (`eritrainer/pipeline/`)
...
### Model Layer
- `eritrainer/models/flux2_klein.py`
- `eritrainer/components/model_setup.py` (Flux2KleinModelSetup)
- `eritrainer/training/predict.py` (Flux2KleinPredictor)

### Memory Layer
- `eritrainer/memory/manager.py`
- `eritrainer/memory/conductor.py`
- `eritrainer/training/block_swap.py`

### Pipeline Layer
- `eritrainer/core/trainer.py`
- `eritrainer/pipeline/dataset.py`
- `eritrainer/pipeline/cache.py`
