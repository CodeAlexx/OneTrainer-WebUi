...
Run with: python -m pytest eritrainer/tests/test_smoke.py -v
"""
...
class TestImports:
    ...
    def test_import_interfaces(self):
        ...
        from eritrainer.core.interfaces import ModelType, BaseModel
    ...
    def test_import_flux2_klein_model(self):
        ...
        from eritrainer.models.flux2_klein import Flux2KleinModel, Flux2KleinModelLoader
        assert Flux2KleinModel is not None
    ...
    def test_import_config(self):
        ...
        from eritrainer.core.config import TrainerConfig, load_config
        assert TrainerConfig is not None
        assert load_config is not None

    def test_import_sampling(self):
        """Sampling module imports."""
        from eritrainer.sampling import (
            create_sampler,
            FluxSampler,
            Flux2Sampler,
            ZImageSampler,
...
class TestTrainingUtilities:
    ...
    def test_device_equals(self):
        ...
        from eritrainer.training.torch_util import device_equals
...
class TestSamplingFactory:
    ...
    def test_create_sampler_factory_exists(self):
        ...
        from eritrainer.sampling import create_sampler
